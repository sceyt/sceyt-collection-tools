...
func TestContainsAllByPointer(t *testing.T) {
	...
	t.Run("test containsAll for pointers", func(t *testing.T) {
		res := ContainsAllByPointer(s1, s2...)
		if res != true {
...
func TestContainsAllByPointerNull(t *testing.T) {
